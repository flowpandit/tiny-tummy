...
- Android local build verification should use JDK 17 for the generated AGP 8.11.x / Gradle 8.14.x project, then run `./scripts/setup-android.sh` and `cd src-tauri/gen/android && ./gradlew :app:compileUniversalDebugKotlin`.
...
7. Production checklist.
   ...
   - Android Kotlin compile verified with JDK 17: `cd src-tauri/gen/android && ./gradlew :app:compileUniversalDebugKotlin`.
